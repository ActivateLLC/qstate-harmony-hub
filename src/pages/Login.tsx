          ...
          <div className="relative z-10 space-y-8">
            ...
            <form className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <button 
                  type="button"
                  className="glass-card py-3 px-4 text-white relative overflow-hidden group flex items-center justify-center space-x-2"
                >
                  <Fingerprint className="w-5 h-5 text-qblue" />
                ...
                <button 
                  ...
                  className="glass-card py-3 px-4 text-white relative overflow-hidden group flex items-center justify-center space-x-2"
                >
                  <Scan className="w-5 h-5 text-qpink" />
